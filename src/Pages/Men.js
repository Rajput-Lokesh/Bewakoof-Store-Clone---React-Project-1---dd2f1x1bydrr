...
export const Men = () => {
  const productUrl = `https://academics.newtonschool.co/api/v1/ecommerce/clothes/products?filter={"gender":"Men"}`;
  ...
  return (
    <>
      <h1 className="text-center text-4xl my-3">{"<- Men Product Page ->"}</h1>
